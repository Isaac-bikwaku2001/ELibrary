...
namespace ELibrary.Controllers
{
    ...
    public class AuteursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AuteurID,Nom,Prenom,Nationalite")] Auteur auteur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AuteurID,Nom,Prenom,Nationalite")] Auteur auteur)
        {
